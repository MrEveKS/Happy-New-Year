...
namespace HappyNewYear.Classes
{
    internal class User32Service : IUser32Service
    {
        ...
        public User32Service(Window window)
        {
            this._window = window;
        }
        ...
        void IUser32Service.HideFromAltTab()
        {
            this.HideFromAltTab(Handle);
        }
        ...
        void IUser32Service.ShoveToBackground()
        {
            SetWindowPos((int)this.Handle, Constants.HWND_BOTTOM, 0, 0, 0, 0, Constants.SWP_NOMOVE | Constants.SWP_NOSIZE | Constants.SWP_SHOWWINDOW);
        }
        #endregion
    }
}
